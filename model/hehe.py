...
class BinaryEncodingCVAE(object):
    def __init__(self, code_length, latent_size=512, feature_length=1024, label_num=60, batch_size=200,
                 sess=tf.Session(),
    ...
    def _build_loss_2(self):
        ...
        loss_out = 0.8 * loss_1 + loss_2 + loss_3 + 0 + loss_5 + loss_r
...
if __name__ == '__main__':
    ...
    data_path = 'E:\\WorkSpace\\Data\\CIFAR10\\cifar_gist_2.hdf5'
    re_file = 'E:\\WorkSpace\\WorkSpace\\SavedModels\\BVAE\\CIFAR10_3\\YMModel-1800'
    model = BinaryEncodingCVAE(code_length=32, feature_length=512, label_num=10, sess=this_session, latent_size=1024,
